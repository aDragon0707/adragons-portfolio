...
- **Socrates Focus**, an evidence-constrained thinking and learning coach.
- **IELTS Assistant**, a live learning tool for reading, writing, OCR, and review cards.
- **Reading Reflection OS**, a system for turning reading into long-term memory.
- **ShadowBuyer / Booking Audit**, a public-facing evidence audit experiment around platform data and claim boundaries.
- **Solo AI Company OS**, a Markdown operating system for coordinating AI workers.
- **SACP / AgentOps Doctor**, a protocol and reference tool for auditable AI agent work receipts.
