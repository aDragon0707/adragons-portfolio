  ...
  if (name === "x") {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path d="M19.4 2.5h2.9l-7.8 8.9L24 21.5h-7.1l-5.5-7.2-6.2 7.2H2.3l8.3-9.5L1 2.5h7.3l5.3 6.8 5.8-6.8Zm-2.5 16h2L6.9 4.8h-2l12 13.7Z" />
      </svg>
    );
  }
  ...
  if (name === "reddit") {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path
          fill="#FF4500"
          d="M12 3a9.5 9.5 0 0 0-8.4 13.8l-.8 3 3.1-.8a9.5 9.5 0 1 0 6.1-16Z"
        />
        <path
          fill="#fff"
          d="M9.2 13.7a.9.9 0 1 1 0-1.8.9.9 0 0 1 0 1.8Zm5.6 0a.9.9 0 1 1 0-1.8.9.9 0 0 1 0 1.8Z"
        />
        <path
          fill="#fff"
          d="M8.4 11.1c0-.3.3-.5.5-.5.5 0 1.1-.3 1.9-.6a8.2 8.2 0 0 1 2.7-.5c1.2 0 2.3.3 3 .7.2.1.3.4.2.6-.1.2-.4.3-.6.2-.7-.4-1.6-.6-2.6-.6-.8 0-1.5.1-2.1.4-.8.3-1.4.7-2.2.7-.3 0-.5-.2-.5-.4Z"
        />
        <path
          fill="#fff"
          d="M7.8 15.1c.2-.2.5-.2.7 0 .9.7 2.1 1 3.5 1s2.6-.3 3.5-1c.2-.2.5-.2.7 0s.2.5 0 .7c-1.1.9-2.5 1.3-4.2 1.3s-3.1-.4-4.2-1.3c-.2-.2-.2-.5 0-.7Z"
        />
        <path
          fill="#fff"
          d="M15.6 7.2a1.1 1.1 0 1 1-2.2 0 1.1 1.1 0 0 1 2.2 0Z"
        />
        <path
          fill="#fff"
          d="M13.3 4.2c0-.4.3-.7.7-.7.3 0 .6.2.6.5 0 .6-.4 1-.8 1.4-.2.2-.5.2-.7 0a.5.5 0 0 1 0-.7c.1-.1.2-.3.2-.5Z"
        />
      </svg>
    );
  }
